...
const createImage = async (req, res, next) => {
   ...
   const dataImg = req.body.img;
   const filename = new Date().getTime()
   const pathToSaveImage = `./src/view/images/${filename}.jpg`;
   ...
   // try {
   //    converBase64ToImage(dataImg, pathToSaveImage);

   //       setTimeout(() => {
   //          console.log(`Imagen creada exitosamente en ${pathToSaveImage}`);
   //          req.body.imgName = pathToSaveImage;
   //          next();
   //       }, 2000);
...
//    const valor2 = valores[1] ? await base64Image(path.join(__dirname, '..', `view/img/valor_${valores[1].replace(" ", "_").toLowerCase()}_sc.svg`), "svg+xml") : await base64Image(path.join(__dirname, '..', `view/img/sinFondo.png`));
//    const valor3 = valores[2] ? await base64Image(path.join(__dirname, '..', `view/img/valor_${valores[2].replace(" ", "_").toLowerCase()}_sc.svg`), "svg+xml") : await base64Image(path.join(__dirname, '..', `view/img/sinFondo.png`));
